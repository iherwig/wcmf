...
dojo.declare("dijit.layout._ContentPaneResizeMixin",null,{doLayout:true,isLayoutContainer:true,startup:function(){
if(this._started){
return;
}
var _1=dijit._Contained.prototype.getParent.call(this);
this._childOfLayoutWidget=_1&&_1.isLayoutContainer;
