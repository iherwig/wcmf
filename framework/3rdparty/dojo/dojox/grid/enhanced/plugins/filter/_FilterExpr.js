...
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicAND",_1._BiOpExpr,{_calculate:function(_2,_3,_4,_5){
var _6=_2.applyRow(_4,_5).getValue()&&_3.applyRow(_4,_5).getValue();
return new _1.BooleanExpr(_6);
},getName:function(){
return "and";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicOR",_1._BiOpExpr,{_calculate:function(_7,_8,_9,_a){
var _b=_7.applyRow(_9,_a).getValue()||_8.applyRow(_9,_a).getValue();
return new _1.BooleanExpr(_b);
},getName:function(){
return "or";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicXOR",_1._BiOpExpr,{_calculate:function(_c,_d,_e,_f){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicNOT",_1._UniOpExpr,{_calculate:function(_12,_13,_14){
return new _1.BooleanExpr(!_12.applyRow(_13,_14).getValue());
},getName:function(){
return "not";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicALL",_1._OperatorExpr,{applyRow:function(_15,_16){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.LogicANY",_1._OperatorExpr,{applyRow:function(_17,_18){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.EqualTo",_1._BiOpExpr,{_calculate:function(_1f,_20,_21,_22){
var res=_19(_1f,_20,_21,_22);
return new _1.BooleanExpr(res===0);
},getName:function(){
return "equal";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LessThan",_1._BiOpExpr,{_calculate:function(_23,_24,_25,_26){
var res=_19(_23,_24,_25,_26);
return new _1.BooleanExpr(res<0);
},getName:function(){
return "less";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LessThanOrEqualTo",_1._BiOpExpr,{_calculate:function(_27,_28,_29,_2a){
var res=_19(_27,_28,_29,_2a);
return new _1.BooleanExpr(res<=0);
},getName:function(){
return "lessEqual";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LargerThan",_1._BiOpExpr,{_calculate:function(_2b,_2c,_2d,_2e){
var res=_19(_2b,_2c,_2d,_2e);
return new _1.BooleanExpr(res>0);
},getName:function(){
return "larger";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.LargerThanOrEqualTo",_1._BiOpExpr,{_calculate:function(_2f,_30,_31,_32){
var res=_19(_2f,_30,_31,_32);
return new _1.BooleanExpr(res>=0);
},getName:function(){
return "largerEqual";
}});
dojo.declare("dojox.grid.enhanced.plugins.filter.Contains",_1._BiOpExpr,{_calculate:function(_33,_34,_35,_36){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.StartsWith",_1._BiOpExpr,{_calculate:function(_39,_3a,_3b,_3c){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.EndsWith",_1._BiOpExpr,{_calculate:function(_3f,_40,_41,_42){
...
dojo.declare("dojox.grid.enhanced.plugins.filter.Matches",_1._BiOpExpr,{_calculate:function(_45,_46,_47,_48){
