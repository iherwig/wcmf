...
class RDBOneToManyRelationDescription extends RelationDescription
{
   ...
   * @param idColumn The name of the column in 'this' end's table, that is referenced by the foreign key column in the 'other' end's table
   * @param fkColumn The name of the foreign key column in the 'other' end's table
   */
