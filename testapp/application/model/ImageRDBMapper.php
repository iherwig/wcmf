...
// PROTECTED REGION END
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: ?
      */
      'filename' => new RDBAttributeDescription('filename', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', true, 'filebrowser', 'image', 'Image', 'file'),
     /**
      * Value description: 
      */
      'created' => new RDBAttributeDescription('created', 'ChiNode:530', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Image', 'created'),
     /**
      * Value description: ?
      */
      'creator' => new RDBAttributeDescription('creator', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Image', 'creator'),
     /**
      * Value description: ?
      */
      'modified' => new RDBAttributeDescription('modified', 'ChiNode:530', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Image', 'modified'),
     /**
      * Value description: ?
      */
      'last_editor' => new RDBAttributeDescription('last_editor', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Image', 'last_editor'),
      /**
