...
// PROTECTED REGION END
  ...
  protected function getRelationDescriptions() {
    return array(
      'UserRDB' => new RDBManyToOneRelationDescription('Locktable', 'Locktable', 'UserRDB', 'UserRDB', '0', 'unbounded', '1', '1', 'composite', 'none', 'true', 'true', 'parent', 'id', 'fk_user_id'),
    );
  }
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: ?
      */
      'objectid' => new RDBAttributeDescription('objectid', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'locktable', 'objectid'),
     /**
      * Value description: ?
      */
      'sessionid' => new RDBAttributeDescription('sessionid', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'locktable', 'sessionid'),
     /**
      * Value description: ?
      */
      'since' => new RDBAttributeDescription('since', 'ChiNode:530', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'locktable', 'since'),
    );
  }
