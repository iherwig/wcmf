...
// PROTECTED REGION END
  ...
  protected function getRelationDescriptions() {
    return array(
      'UserRDB' => new RDBManyToOneRelationDescription('UserConfig', 'UserConfig', 'UserRDB', 'UserRDB', '0', 'unbounded', '1', '1', 'composite', 'none', 'true', 'true', 'parent', 'id', 'fk_user_id'),
    );
  }
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: ?
      */
      'key' => new RDBAttributeDescription('key', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'user_config', 'key'),
     /**
      * Value description: ?
      */
      'val' => new RDBAttributeDescription('val', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', true, 'text', 'text', 'user_config', 'val'),
    );
  }
