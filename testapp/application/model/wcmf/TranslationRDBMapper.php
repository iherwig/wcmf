...
// PROTECTED REGION END
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      */
      'objectid' => new RDBAttributeDescription('objectid', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'translation', 'objectid'),
     /**
      * Value description: The attribute of the object that is translated
      */
      'attribute' => new RDBAttributeDescription('attribute', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'translation', 'attribute'),
     /**
      * Value description: The translation
      */
      'translation' => new RDBAttributeDescription('translation', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'textarea', 'text', 'translation', 'translation'),
     /**
      * Value description: The language of the translation
      */
      'language' => new RDBAttributeDescription('language', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'translation', 'language'),
    );
  }
