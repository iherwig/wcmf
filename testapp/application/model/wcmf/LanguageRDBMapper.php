...
// PROTECTED REGION END
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: ?
      */
      'name' => new RDBAttributeDescription('name', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'language', 'name'),
     /**
      * Value description: ?
      */
      'code' => new RDBAttributeDescription('code', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'language', 'code'),
    );
  }
