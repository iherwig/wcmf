...
// PROTECTED REGION END
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: ?
      */
      'name' => new RDBAttributeDescription('name', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', true, 'text', 'text', 'Author', 'name'),
     /**
      * Value description: 
      */
      'created' => new RDBAttributeDescription('created', 'ChiNode:530', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Author', 'created'),
     /**
      * Value description: ?
      */
      'creator' => new RDBAttributeDescription('creator', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Author', 'creator'),
     /**
      * Value description: ?
      */
      'modified' => new RDBAttributeDescription('modified', 'ChiNode:530', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Author', 'modified'),
     /**
      * Value description: ?
      */
      'last_editor' => new RDBAttributeDescription('last_editor', 'ChiNode:531', array('DATATYPE_ATTRIBUTE'), null, '', '', '', false, 'text', 'text', 'Author', 'last_editor'),
    );
  }
