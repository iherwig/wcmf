...
// PROTECTED REGION END
  ...
  protected function getRelationDescriptions() {
    return array(
      'Chapter' => new RDBOneToManyRelationDescription('Author', 'Author', 'Chapter', 'Chapter', '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_author_id'),
      'Publisher' => new RDBManyToManyRelationDescription(
        /* this -> nm  */ new RDBOneToManyRelationDescription('Author', 'Author', 'NMPublisherAuthor', 'NMPublisherAuthor', '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_author_id'),
        /* nm -> other */ new RDBManyToOneRelationDescription('NMPublisherAuthor', 'NMPublisherAuthor', 'Publisher', 'Publisher', '0', 'unbounded', '1', '1', 'composite', 'none', 'true', 'true', 'parent', 'id', 'fk_publisher_id')
      ),
    );
  }
