...
use testapp\application\model\PublisherRDBMapper;
...
class NodeUnifiedRDBMapperTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testInsertSQL() {
    ...
    $op = $operations[0];
    $str = $op->__toString();
    $this->assertEquals('wcmf\lib\persistence\InsertOperation:type=Chapter,values=(id=1,fk_chapter_id=3,fk_author_id=2,name=Chapter 1,created=2010-02-21,creator=admin),criteria=()', $str);
  }
  ...
  public function testUpdateSQL() {
    ...
    $op = $operations[0];
    $str = $op->__toString();
    $this->assertEquals('wcmf\lib\persistence\UpdateOperation:type=Chapter,values=(id=1,fk_chapter_id=3,fk_author_id=2,name=Chapter 1,created=2010-02-21,creator=admin),criteria=([AND] Chapter.id = 1)', $str);
  }
  ...
  public function testDeleteSQL() {
    ...
    $op = $operations[0];
    $str = $op->__toString();
    $this->assertEquals('wcmf\lib\persistence\DeleteOperation:type=Chapter,values=(),criteria=([AND] Chapter.id = 1)', $str);
  }
}
?>