...
use wcmf\test\app\src\model\Publisher;
...
class PublisherRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.Publisher';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/PublisherRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'Book' => new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.Publisher', 'Publisher', 'wcmf.test.app.src.model.Book', 'Book',
      ...
      /* this -> nm  */ new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.Publisher', 'Publisher', 'wcmf.test.app.src.model.NMPublisherAuthor', 'NMPublisherAuthor',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_publisher_id'
      ),
      /* nm -> other */ new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.NMPublisherAuthor', 'NMPublisherAuthor', 'wcmf.test.app.src.model.Author', 'Author',
