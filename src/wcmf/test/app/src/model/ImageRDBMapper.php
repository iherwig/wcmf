...
class ImageRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.Image';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/ImageRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'TitleChapter' => new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.Image', 'TitleImage', 'wcmf.test.app.src.model.Chapter', 'TitleChapter',
        '0', '1', '1', '1', 'shared', 'none', 'true', 'true', 'parent', 'id', 'fk_titlechapter_id'
      ),
      'NormalChapter' => new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.Image', 'NormalImage', 'wcmf.test.app.src.model.Chapter', 'NormalChapter',
