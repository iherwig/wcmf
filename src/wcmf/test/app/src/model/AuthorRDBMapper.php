...
class AuthorRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.Author';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/AuthorRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'Chapter' => new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.Author', 'Author', 'wcmf.test.app.src.model.Chapter', 'Chapter',
      ...
      /* this -> nm  */ new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.Author', 'Author', 'wcmf.test.app.src.model.NMPublisherAuthor', 'NMPublisherAuthor',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_author_id'
      ),
      /* nm -> other */ new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.NMPublisherAuthor', 'NMPublisherAuthor', 'wcmf.test.app.src.model.Publisher', 'Publisher',
