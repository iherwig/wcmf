...
use wcmf\test\app\src\model\wcmf\UserConfig;
...
class UserConfigRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.wcmf.UserConfig';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/wcmf/UserConfigRDBMapper.php/Properties) ENABLED START
// PROTECTED REGION END
  ...
  protected function getRelationDescriptions() {
    return array(
      'User' => new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.wcmf.UserConfig', 'UserConfig', 'wcmf.test.app.src.model.wcmf.User', 'User',
  ...
  protected function getAttributeDescriptions() {
    return array(
      ...
      * Value description: 
      */
      'id' => new RDBAttributeDescription('id', '', array('DATATYPE_IGNORE'), null, '', '', false, 'text', 'text', 'UserConfig', 'id'),
     /**
      * Value description: 
      */
      'fk_user_id' => new RDBAttributeDescription('fk_user_id', '', array('DATATYPE_IGNORE'), null, '', '', false, 'text', 'text', 'UserConfig', 'fk_user_id'),
     /**
      * Value description: 
      */
      'key' => new RDBAttributeDescription('key', 'String', array('DATATYPE_ATTRIBUTE'), null, '', '', false, 'text', 'text', 'UserConfig', 'key'),
     /**
      * Value description: 
      */
      'val' => new RDBAttributeDescription('val', 'String', array('DATATYPE_ATTRIBUTE'), null, '', '', true, 'text', 'text', 'UserConfig', 'val'),
    );
  }
