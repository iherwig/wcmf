...
use wcmf\test\app\src\model\wcmf\User;
...
class UserRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.wcmf.User';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/wcmf/UserRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'Locktable' => new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.wcmf.User', 'User', 'wcmf.test.app.src.model.wcmf.Locktable', 'Locktable',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_user_id'
      ),
      'UserConfig' => new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.wcmf.User', 'User', 'wcmf.test.app.src.model.wcmf.UserConfig', 'UserConfig',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_user_id'
      ),
      'Role' => new RDBManyToManyRelationDescription(
      /* this -> nm  */ new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.wcmf.User', 'User', 'wcmf.test.app.src.model.wcmf.NMUserRole', 'NMUserRole',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_user_id'
      ),
