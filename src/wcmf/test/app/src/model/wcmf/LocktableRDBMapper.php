...
use wcmf\test\app\src\model\wcmf\Locktable;
...
class LocktableRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.wcmf.Locktable';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/wcmf/LocktableRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'User' => new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.wcmf.Locktable', 'Locktable', 'wcmf.test.app.src.model.wcmf.User', 'User',
