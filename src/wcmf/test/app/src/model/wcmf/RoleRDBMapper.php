...
class RoleRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.wcmf.Role';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/wcmf/RoleRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      ...
      /* this -> nm  */ new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.wcmf.Role', 'Role', 'wcmf.test.app.src.model.wcmf.NMUserRole', 'NMUserRole',
