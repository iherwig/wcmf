...
class BookRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getType() {
    return 'wcmf.test.app.src.model.Book';
  }
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(wcmf/test/app/src/model/BookRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'Chapter' => new RDBOneToManyRelationDescription(
        'wcmf.test.app.src.model.Book', 'Book', 'wcmf.test.app.src.model.Chapter', 'Chapter',
        '1', '1', '0', 'unbounded', 'none', 'shared', 'true', 'true', 'child', 'id', 'fk_book_id'
      ),
      'Publisher' => new RDBManyToOneRelationDescription(
        'wcmf.test.app.src.model.Book', 'Book', 'wcmf.test.app.src.model.Publisher', 'Publisher',
