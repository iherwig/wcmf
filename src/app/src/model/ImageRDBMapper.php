...
class ImageRDBMapper extends NodeUnifiedRDBMapper {
  ...
  public function getProperties() {
    return array(
      ...
      'parent_order' => '',
      'child_order' => '',
// PROTECTED REGION ID(app/src/model/ImageRDBMapper.php/Properties) ENABLED START
  ...
  protected function getRelationDescriptions() {
    return array(
      'TitleChapter' => new RDBManyToOneRelationDescription(
        'app.src.model.Image', 'TitleImage', 'app.src.model.Chapter', 'TitleChapter',
        '0', '1', '1', '1', 'shared', 'none', 'true', 'true', 'parent', 'id', 'fk_titlechapter_id'
      ),
      'NormalChapter' => new RDBManyToOneRelationDescription(
        'app.src.model.Image', 'NormalImage', 'app.src.model.Chapter', 'NormalChapter',
