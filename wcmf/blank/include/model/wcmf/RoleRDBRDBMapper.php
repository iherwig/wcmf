...
require_once(WCMF_BASE."application/include/model/wcmf/RoleRDB.php");
...
class RoleRDBRDBMapper extends NodeUnifiedRDBMapper
{
  ...
  public function getProperties()
  {
    return array(
      'is_searchable' => true,
      'display_value' => 'name',
// PROTECTED REGION ID(application/include/model/wcmf/RoleRDBRDBMapper.php/Properties) ENABLED START
