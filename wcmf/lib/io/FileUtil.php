...
require_once(WCMF_BASE."wcmf/lib/util/IOException.php");
require_once(WCMF_BASE."wcmf/lib/core/IllegalArgumentException.php");
...
class FileUtil
{
   ...
   */
  public static function uploadFile($mediaFile, $destName, $mimeType=null, $maxSize=-1, $override=true)
  {
    $filename = null;
