 ...
 */
class ListControllerTest extends \Codeception\Test\Unit {

  const TEST_OID = 'User:0';

  const CONTROLLER = 'wcmf\application\controller\ListController';
  ...
  public function testSimpleList() {
    ...
    $response = $this->tester->runRequest('list', self::CONTROLLER, $data);
