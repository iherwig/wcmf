 ...
 */
class SaveControllerTest extends \Codeception\Test\Unit {
  ...
  const CONTROLLER = 'wcmf\application\controller\SaveController';
  ...
  public function testSave() {
    ...
    $this->tester->runRequest('update', self::CONTROLLER, $data);
  ...
  public function testInsert() {
    ...
    $response = $this->tester->runRequest('create', self::CONTROLLER, $data);
