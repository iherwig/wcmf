 ...
 */
class SortControllerTest extends \Codeception\Test\Unit {

  const CONTROLLER = 'wcmf\application\controller\SortController';
  ...
  public function testAscMoveBeforeTop() {
    ...
    $this->tester->runRequest('moveBefore', self::CONTROLLER, $data);
  ...
  public function testAscInsertBeforeTop() {
    ...
    $this->tester->runRequest('insertBefore', self::CONTROLLER, $data);
